...
OUT_DIR_FIG = ''
DIR_FIBER_MASK = Path(r"Z:\Jingyu\Dbh_fiber_detecion/dlight_Ai14_Dbh")
...
for rec in tqdm(all_rec):
    ...
    p_regression_res = OUR_DIR_REGRESS / rec / regression_name / r'dilation_k=0'/ 'corrected_dlight_trace.npy'
    
    if p_regression_res.exists():
        ...
        p_masks = utl.load_masks_axon_dlight(rec, OUR_DIR_REGRESS, dilation_steps=DILATION_STEPS,
                                             ...
                                             p_fiber_masks = DIR_FIBER_MASK/rec,
                                             fiber_mask_name = 'ch2_mean.npy_ROI_dict_selected.npy',
                                             visualize_neu = True,
